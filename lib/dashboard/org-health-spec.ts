...
export const ORG_HEALTH_SPEC: HealthSection[] = [
  {
    ...
    tiles: [
      ...
      { label: 'Mental Health Services', metricKey: 'mental_health_sessions', note: 'annual total' },
  ...
  },
  {
    ...
    tiles: [
      ...
      { label: 'People Trained', metricKey: 'education_people_trained', note: 'annual total' },
