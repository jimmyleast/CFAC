...
export const ORG_HEALTH_SPEC: HealthSection[] = [
  {
    ...
    tiles: [
      ...
      { label: 'Children Served', metricKey: 'children_served', note: 'annual total' },
      { label: 'Forensic Interviews', metricKey: 'forensic_interviews', note: 'annual total' },
      { label: 'Medical Exams', metricKey: 'medical_exams', note: 'annual total' },
      { label: 'Mental Health Sessions', metricKey: 'mental_health_sessions', note: 'annual total' },
  ...
  },
  {
    ...
    tiles: [
      ...
      { label: 'People Trained', metricKey: 'education_trainings', note: 'annual (education)' },
      { label: 'Community Event Attendance', metricKey: 'community_event_attendance', note: 'annual total' },
  ...
  },
  {
    ...
    tiles: [
      { label: 'Maintenance Requests', metricKey: 'maintenance_requests', note: 'monthly' },
      { label: 'Maintenance On-Time Rate', metricKey: 'maintenance_on_time_rate', note: 'monthly %', aggregate: 'last' },
      { label: 'Fleet Trips', metricKey: 'fleet_trips', note: 'monthly' },
      { label: 'Fleet Miles', metricKey: 'fleet_miles', note: 'monthly' },
    ],
  },
  {
    title: 'Finance & HR',
